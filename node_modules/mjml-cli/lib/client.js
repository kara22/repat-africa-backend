    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          argv = _yargs2.default.version(false) // cf. https://github.com/yargs/yargs/issues/961
          .options({
            r: {
              alias: 'read',
        ...
        case 30:
          (0, _watchFiles2.default)(inputFiles, (0, _extends3.default)({}, argv, { config: config }));
          KEEP_OPEN = true;
          return _context.abrupt('break', 40);
            ...
            try {
              ...
              switch (inputOpt) {
                ...
                case 'v':
                  ...
                  break;
                default:
                  compiled = (0, _mjmlCore2.default)(i.mjml, (0, _extends3.default)({}, config, {
